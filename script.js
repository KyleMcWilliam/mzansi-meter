...
function nextQuestion() {
    ...
    function updateScoreDisplay() {
        const previousScore = parseInt(currentScoreDisplay.textContent) || 0;
        animateValue(currentScoreDisplay, previousScore, currentScore, 500);
    ...
    function updateLivesDisplay() {
        let heartsHtml = '';
        const heartSvg = `<svg class="heart-icon" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
